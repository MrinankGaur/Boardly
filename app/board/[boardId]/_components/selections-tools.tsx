...
export const SelectionTools = memo(({
    ...
    const selectinBounds = useSelectionBounds();

    if(!selectinBounds){
        return null;
    }

    const x = selectinBounds.width/2 + selectinBounds.x + camera.x;
    const y = selectinBounds.y + camera.y;
    ...
    return(
        ...
        >
            ...
            >
                ...
                <Hint
                    label="Send to back" side="bottom"
                >
                    <Button
                        variant="board"
                        size="icon"
